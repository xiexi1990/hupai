...
//	logfont.lfPitchAndFamily = DEFAULT_PITCH | FF_SWISS;
	...
	//		DrawFrame(&PP->m_dcmDraw1, pinfos[i].m_MingGangWrdRect, 0);
			PP->m_dcmDraw1.DrawText(L"Ã÷", &pinfos[i].m_MingGangWrdRect, DT_CENTER|DT_VCENTER|DT_SINGLELINE|DT_NOCLIP);
			...
			PP->m_dcmDraw1.DrawText(L"°µ", &pinfos[i].m_AnGangWrdRect, DT_CENTER|DT_VCENTER|DT_SINGLELINE|DT_NOCLIP);
